...
i18n_opts = [
    cfg.StrOpt('domain',
               default='default',
               help='Gettext translation doamin'),
]

CONF = cfg.CONF
CONF.register_opts(i18n_opts, 'i18n')
...
def _(msg):
    ...
    if USE_LAZY:
        ...
        if not _TRANSLATION:
            _localedir = os.environ.get(CONF.i18n.domain.upper() +
                                        '_LOCALEDIR')
            _TRANSLATION = gettext.translation(CONF.i18n.domain,
